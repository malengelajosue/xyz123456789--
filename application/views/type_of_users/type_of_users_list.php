<div class="box box-info">
            ...
            <!-- /.box-header -->
            <div class="box-body">
        <h2 style="margin-top:0px">Type_of_users List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('type_of_users/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<?php echo anchor(site_url('type_of_users/excel'), 'Excel', 'class="btn btn-primary"'); ?>
	    </div>
